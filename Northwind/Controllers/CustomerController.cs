    ...
    public class CustomerController : Controller
    {
        ...
        public ActionResult ForgotPassword(FormCollection Form, string ReturnUrl)
        {
            using(NORTHWNDEntities db = new NORTHWNDEntities()){
                ...
                gmailer.Body = "<p>Hello {ContactName},</p>"+
...
"<p>If you didn't request a new password, <a href='" + Request.Url.GetLeftPart(UriPartial.Authority) + "/Customer/Disavow?id={guid}&n={secret code}'>let us know</a>.</p>";
                gmailer.IsHtml = true;
                gmailer.Send();
